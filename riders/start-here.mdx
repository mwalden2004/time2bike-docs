---
title: "Start here"
description: "New to Time2Bike? Follow these steps to create an account and register for a race."
icon: "flag-checkered"
---

If you've been sent a link to a race and you've never used Time2Bike before,
start with these six steps. Check the organizer's event instructions for
eligibility, equipment, check-in, and other race-day requirements.
...
<Steps>
  ...
  <Step title="Understand the one confusing bit">
    ...
    You have one account. On it you can have several rider profiles: yourself,
  ...
  <Step title="Work through registration">
    ...
    3. **Questions.** Whatever the organizer asks, like t-shirt size or category.
    4. **Add-ons.** Merch, parking passes.
    5. **Review & pay.** The discount code goes in here.
  ...
  <Step title="Check your confirmation">
    Check the entry and its status on your
    [dashboard](https://time2.bike/dashboard), along with your confirmation email.
    Your name can also appear on the start list if the organizer makes it public.

    Full detail: [Checkout & confirmation](/riders/registering/checkout-and-confirmation).
  </Step>
  <Step title="Race day">
    Follow the organizer's check-in and start instructions. Times appear on the
    event's **Results** page when live results are enabled. Published results
    use that same page; the organizer or sanctioning body determines when they
    are official.
...
<AccordionGroup>
  <Accordion title="I'm signing up my kids" icon="children">
    Make a rider profile for each child on your own account. You pay once,
    ...
    [Your rider profile](/riders/race-day/rider-profile#sharing-a-profile).
  </Accordion>
  ...
  <Accordion title="I need to change or cancel my entry" icon="rotate-left">
    Open the entry on your [Dashboard](https://time2.bike/dashboard) and choose
    **Request cancellation**. That sends the organizer a request with your reason; they
    decide under their own refund terms and you see the outcome on the same
    entry. For a change of race or rider, contact the organizer directly.
  </Accordion>
</AccordionGroup>
...
| Manage account details or change my password | [Account settings](https://time2.bike/account/settings) |
