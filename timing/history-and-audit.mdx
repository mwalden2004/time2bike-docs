...
Time2Bike keeps a complete history of everything that happens to a timing
session: every finish recorded, every time edited, every rider marked DNF, every
entry deleted, and who did each one.
...
| A finalized session you unlock and change | Every version of the number is still there |
...
support and ask for the audit trail for your session.
