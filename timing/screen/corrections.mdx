...
both remain. See [History & corrections](/timing/concepts/event-log).
...
<AccordionGroup>
  ...
  <Accordion title="Nobody pressed Start" icon="clock">
    Keep recording finishes. They'll sit as **awaiting start**. Press **Start**
    and every elapsed time fills itself in from the actual start moment.
  ...
  <Accordion title="I finalized too early" icon="lock-open">
    Unlock the session from its menu, make your corrections, and finalize again.
    Republish if you'd already published.
  </Accordion>
</AccordionGroup>
...
→ [Who can do what](/timing/concepts/roles)
