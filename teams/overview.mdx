...
Find your teams at [time2.bike/teams](https://time2.bike/teams), or under
**Teams** in the top navigation once you're signed in.
...
These are separate parts of Time2Bike with their own roles. A role in one does
not give you general management access to the others.
...
with them, showing next to their name on start lists and results. But the
organization and team need their own management permissions.
...
<AccordionGroup>
  ...
  <Accordion title="Practices you can actually time" icon="stopwatch">
    Schedule a practice, and active roster athletes are added automatically. Run a
  ...
  <Accordion title="A coach's clipboard" icon="clipboard-list">
    Compare athletes' recorded practice times and trends.
    See [The clipboard](/teams/clipboard).
  </Accordion>
  <Accordion title="Emergency info" icon="briefcase-medical">
    Recorded emergency contacts and medical notes, with a printable sheet for
    staff. See [Emergency & medical info](/teams/emergency-info).
  </Accordion>
  <Accordion title="A public page" icon="globe">
    Logo, bio, roster, and an apply button, at an address like
    `time2.bike/team/bay-area-cc`. See [Your public page](/teams/public-page).
  </Accordion>
</AccordionGroup>
...
<Columns cols={2}>
  ...
  <Card title="I'm setting up a new team" icon="flag" href="/teams/start-a-team">
    Create the team and get your riders on the roster.
  </Card>
</Columns>
