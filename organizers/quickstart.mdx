...
<Steps>
  ...
  <Step title="Set up timing">
    Create a timing session, pick your mode, and issue scoped tokens or QR codes
    to your operators. They don't need org access.

    → [Operator quickstart](/timing/operator-quickstart)
  </Step>
...
<AccordionGroup>
  ...
  <Accordion title="Giving timing volunteers org accounts" icon="triangle-exclamation">
    Use scoped timing tokens instead — they work on one session and nothing
    else. See [Tokens & QR](/timing/setup/tokens-and-qr).
  </Accordion>
</AccordionGroup>
